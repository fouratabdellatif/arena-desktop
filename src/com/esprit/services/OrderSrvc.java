...
public class OrderSrvc {
    ...
    public void exportTable() throws SQLException, FileNotFoundException {
        try {
            ...
            PdfWriter.getInstance(my_pdf_report, new FileOutputStream("C:/Users/Foura/Documents/NetBeansProjects/arena-desktop/src/com/esprit/uploads/reports/orders/report" + random_id + ".pdf"));
